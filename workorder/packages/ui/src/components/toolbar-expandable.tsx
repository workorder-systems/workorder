...
>(({ className, orientation = "vertical", ...props }, ref) => {
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "hover:bg-muted dark:hover:bg-muted/50 data-[state=visible]:fade-in-0 data-[state=hidden]:fade-out-0 data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=hidden]:animate-out flex touch-none p-px transition-[colors] duration-150 select-none",
...
export type { DynamicStep, DynamicToolbarExpandableProps }
