...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@workspace/components/animate-ui/components/radix/sheet';
import {
  TooltipProvider,
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from '@workspace/components/animate-ui/components/animate/tooltip';
import {
  Highlight,
  HighlightItem,
} from '@workspace/components/animate-ui/primitives/effects/highlight';
import { getStrictContext } from '@workspace/lib/get-strict-context';
